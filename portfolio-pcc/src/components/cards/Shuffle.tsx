...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const baseTw =
    "inline-block whitespace-nowrap will-change-transform uppercase text-[1.15rem] min-[360px]:text-[1.35rem] min-[420px]:text-2xl sm:text-3xl md:text-5xl lg:text-6xl 2xl:text-7xl leading-tight font-extrabold text-blue-500";
